      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="${pageContext.request.contextPath}/customerLogin.jsp">登录</a></li>
            <li><a href="${pageContext.request.contextPath}/customerRegister2.jsp">注册</a></li>
            <li><a href="${pageContext.request.contextPath}/Search.jsp">返回</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar" id="lb">
          <ul class="nav nav-sidebar">
            <li><a href="${pageContext.request.contextPath}/customerLogin.jsp">登录</a></li>
            <li><a href="${pageContext.request.contextPath}/customerRegister2.jsp">注册</a></li>
            <li><a href="${pageContext.request.contextPath}/Search.jsp">查询溯源信息</a></li>

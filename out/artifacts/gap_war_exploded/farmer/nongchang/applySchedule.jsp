        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach var="schedule" items="${sessionScope.schedulePB.list }">
                 	<tr>
            ...
            <div style="float: left;">
	            <form method=post id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/ApplyAction_SearchApplySchedule?userid=${farmer1.id_nh}">
	 				<!-- 隐藏域.当前页码 -->
					<input type="hidden" name="currentPage" id="currentPageInput" value="${schedulePB.currentPage }" />
					<!-- 隐藏域.每页显示条数 -->
						...
						<td>
							<span id=pagelink>
								<div style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">							
									第[<c:out value="${schedulePB.currentPage }"></c:out>]页,
									共[<c:out value="${schedulePB.totalPage }"></c:out>]页													
									[<a href="javaScript:void(0)" onclick="changePage(${schedulePB.currentPage-1 })" style="color:blue" >前一页</A>]
									[<a href="javaScript:void(0)" onclick="changePage(${schedulePB.currentPage+1 })"  style="color:blue" >后一页</A>] 
	<%-- 								，跳转到

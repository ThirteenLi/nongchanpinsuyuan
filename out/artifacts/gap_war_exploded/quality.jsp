	  ...
	  <div id="content" class="container center-block">
	    <div class="jumbotron">
	      <div class="container">
	        ...
	        <p>${error}</p>
	        <form action="QualityAction_searchQuality" method="post">
	        <div class="input-group input-group-lg" > 
	        	<span class="input-group-addon" id="sizing-addon1" style="width: 260px;">
	          		<input name="id_pro" style="width: 260px;" type="text" class="form-control" placeholder="溯源码（批次号）" aria-describedby="sizing-addon1">
				</span>
	        </div>

			...
			<div class="panel panel-default">
				<div class="panel-heading">确认订单</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" enctype="multipart/form-data" action="ProductAction_DLSSaveProduct1" method="POST">
							<input type="hidden" value="${agentorder1.productid }" name="idHead_rep">
							<input type="hidden" value="${agentorder1.id_order }" name="id_order">
							<div class="form-group">
						    	<label for="mobile" class="col-sm-2 control-label" style="text-align:left;">产品名</label>
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.productName }" type="text"  name="name_rep" id="name_rep" class="form-control"/>
						    		<label id="ts"></label>
						    	</div>	
							</div>
							...
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.buyerid }" type="text"  name="idOwner_rep" id="sellPrice_rep" class="form-control"/>
						    		<label id="ts"></label>
						    	</div>	
							</div>
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.id_shop }" type="text"  name="idPlace_rep" id="idPlace_rep" class="form-control"/>
						    		<label id="ts"></label>
						    	</div>	
							</div>	
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.buynumber }" type="text"  name="number_rep" id="number_rep" class="form-control"/>
						    	</div>
							</div>
							<div class="form-group">
						    	<label for="email" class="col-sm-2 control-label" style="text-align:left;">成交单价（元）</label>
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.buyPrice }"  type="text" name="buyPrice_rep" id="buyPrice_rep" class="form-control"/>
						    	</div>
							</div>
							<div class="form-group">
						    	<label for="name" class="col-sm-2 control-label" style="text-align:left;">成交计量单位</label>
						    	<div class="col-sm-8">
								      <input readonly="readonly" value="${agentorder1.buyUnit }"  type="text" name="buyUnit_rep" id="buyUnit_rep" class="form-control"/>
						    	</div>
							</div>

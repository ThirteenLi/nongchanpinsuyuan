      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar" id="lb">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="#">管理代理点 <span class="sr-only">(current)</span></a></li>
            <li ><a href="#" >录入产品</a></li>
            <li><a href="#">管理仓库</a></li>
            <li><a href="#">管理订单</a></li>
            <li><a href="#">管理个人信息</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <!-- 主标题 -->
          <h1 class="page-header">代理点管理</h1>
          
          
          <!-- 圆圈 -->
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
            <a href="${pageContext.request.contextPath }/agent/shop/applyShop.jsp">
              ...
              <h4>申请新代理点</h4>              
            <span class="text-muted">Apply a new shop</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">             
              <a href="${pageContext.request.contextPath }/agent/shop/changeShopApply.jsp">
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
            <a href="${pageContext.request.contextPath }/ApplyAction_SearchdlsApplySchedule?userid=${agent1.id_dls}">
			...
			<!-- 主要内容 -->
          <h2 class="sub-header">我的代理点</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th width="10%">代理点编号</th>
                  <th width="15%">代理点名称</th>
                  <th width="15%">地址</th>
                  <th width="15%">交通</th>
                  <th width="15%">主要经营</th>
                </tr>
              ...
              <tbody>
                <c:forEach var="myshop" items="${sessionScope.shoppageBean.list }">
                 	<tr>
                		<td><c:out value="${myshop.id_shop }"></c:out></td>
                		<td><c:out value="${myshop.name_shop }"></c:out></td>
                		<td><c:out value="${myshop.address_shop }"></c:out></td>
                		<td><c:out value="${myshop.traffic_shop }"></c:out></td>
                		<td><c:out value="${myshop.mainProduct_shop }"></c:out></td>
                	</tr>               
                </c:forEach>
              </tbody>
            </table>
            ...
            <div style="float: left;">
	            <form method=post id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/ShopAction_list?id_nh=${shoper1.id_nh}">
	 				<!-- 隐藏域.当前页码 -->
					<input type="hidden" name="currentPage" id="currentPageInput" value="${shoppageBean.currentPage }" />
					<!-- 隐藏域.每页显示条数 -->
						...
						<td>
							<span id=pagelink>
								<div style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">							
									第[<c:out value="${shoppageBean.currentPage }"></c:out>]页,
									共[<c:out value="${shoppageBean.totalPage }"></c:out>]页													
									[<a href="javaScript:void(0)" onclick="changePage(${shoppageBean.currentPage-1 })" style="color:blue" >前一页</A>]
									[<a href="javaScript:void(0)" onclick="changePage(${shoppageBean.currentPage+1 })"  style="color:blue" >后一页</A>] 

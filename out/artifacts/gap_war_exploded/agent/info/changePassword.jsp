			...
			<div class="panel panel-default">
				<div class="panel-heading">修改密码</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm4" enctype="multipart/form-data" action="${pageContext.request.contextPath}/AgentAction_changeAgentPassword" method="POST">
							<div class="form-group">
						    	<label for="loginName" class="col-sm-2 control-label" style="text-align:left;">${AgentChangePassworderror}</label>
							</div>							
							<div class="form-group">
						    	<label for="loginName" class="col-sm-2 control-label" style="text-align:left;">输入原密码</label>
						    	<div class="col-sm-8">
								      <input type="password"  name="password_dls" id="password_dls" class="form-control"/>
						    	</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
 							...
 							<input type="hidden" name="id_dls" value="${agent1.id_dls }">

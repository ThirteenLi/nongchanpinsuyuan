			...
			<div class="panel panel-default">
				<div class="panel-heading">输入变更申请</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm3" enctype="multipart/form-data" action="ApplyAction_NhFarmChangeApply" method="POST">
							...
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
						    		  <select name="applycategory" id="applycategory"  class="selectpicker show-tick form-control" data-live-search="true">
							 			 	 <option value="农场信息修改" selected="selected">农场信息修改申请</option>
											 <option value="农场注销申请">农场注销申请</option>											
								      </select>
						    	</div>
							</div>

        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach var="repository" items="${sessionScope.farmerRepositoryList.list }">
	                 	...
	                 	<tr>
	                		...
	                		href="${pageContext.request.contextPath }/ProductAction_NHGetOneProduct?productId_rep=${repository.productId }">修改信息</a></td>
            ...
            <div style="float: left;">
	            <form method=post id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/ProductAction_NHGetRepository?idOwner_rep=${farmer1.id_nh}">
	 				<!-- 隐藏域.当前页码 -->
					<input type="hidden" name="currentPage" id="currentPageInput" value="${farmerRepositoryList.currentPage }" />
					<!-- 隐藏域.每页显示条数 -->
						...
						<td>
							<span id=pagelink>
								<div style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">							
									第[<c:out value="${farmerRepositoryList.currentPage }"></c:out>]页,
									共[<c:out value="${farmerRepositoryList.totalPage }"></c:out>]页													

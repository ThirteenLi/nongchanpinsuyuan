...
<body class="templatemo-bg-gray">
	<h1 class="margin-bottom-15">农户注册</h1>
	
	<div class="container">
		<div class="col-md-12">			
			<form id="registForm" enctype="multipart/form-data" class="form-horizontal templatemo-create-account templatemo-container" role="form" action="FarmerAction_registNewFarmer" method="post">
				<div class="form-inner">
					<div class="form-group">
			          <div class="col-md-12">		          	
			            <label class="control-label">${farmerRegisterror}</label>            		           
			          </div>             
			        </div>
					<div class="form-group">
			          <div class="col-md-12">		          	
			            <label for="phoneNumber" class="control-label">手机号</label>
			            <input name="phoneNumber_nh" type="text" class="form-control"  placeholder="" maxlength="11"> 		 
			        ...
			        <div class="form-group">
			          <div class="col-md-6">
			            ...
			            <input name="password_nh" type="password" class="form-control" id="password" placeholder="">
			          </div>
			          <div class="col-md-6">
			            <label for="password" class="control-label">确认密码</label>
			            <input name="repassword_nh" type="password" class="form-control" id="password_confirm" placeholder="">
			          </div>
			        </div>			        
			        <div class="form-group">
			          <div class="col-md-12">		          	
			            <label for="username" class="control-label">邮箱</label>
			            <input name="email_nh" type="email" class="form-control" id="email" placeholder="" maxlength="30">		            		            		            
			          </div>              
			        </div>
			        <div class="form-group">
				        <div class="col-md-12">		          	
				            <label for="last_name" class="control-label">身份证号码</label>
				            <input name="IDCardNum_nh" type="text" class="form-control" id="last_name" placeholder="">		            		            		            
				        </div>
				    </div>
			        ...
			        <div class="form-group">
			          <div class="col-md-6">		          	
			            ...
			            <input name="realName_nh" type="text" class="form-control" id="username" placeholder="" maxlength="20">		            		            		            
			          </div>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <label><input name="contract_nh" type="checkbox">我同意 <a href="javascript:;" data-toggle="modal" data-target="#templatemo_modal" id="clj1">绿色农产品溯源系统农户使用协议</a></label>
			          </div>
			        </div>
			        <div class="form-group">
			          <div class="col-md-12">

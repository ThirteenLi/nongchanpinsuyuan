...
<script type="text/javascript">
	$(function(){
		$("#backbtn").click(function(){
			$(window).attr('location',"${pageContext.request.contextPath }/agent/homepage.jsp");
		});
	});
</script>
	  ...
	  <div id="content" class="container center-block">
	    <div class="jumbotron">
	      <div class="container">
	        ...
	        <p>${searchError }</p>
	        <form action="ProductAction_AgentSearch" method="post">
	        <div class="input-group input-group-lg" > 
	        	<span class="input-group-addon" id="sizing-addon1" style="width: 260px;">
	          		<input name="productId_rep" style="width: 260px;" type="text" class="form-control" placeholder="批次号" aria-describedby="sizing-addon1">
				</span>
	        </div>

			...
			<div class="panel panel-default">
				<div class="panel-heading">输入变更申请</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm3" enctype="multipart/form-data" action="ApplyAction_DLSShopChangeApply" method="POST">
							<input type="hidden" value="${agent1.id_dls}" name="userid" />
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
						    		  <select name="applycategory" id="applycategory"  class="selectpicker show-tick form-control" data-live-search="true">
							 			 	 <option value="代理点信息修改" selected="selected">代理点信息修改申请</option>
											 <option value="代理点注销申请">代理点注销申请</option>											
								      </select>
						    	</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-5 col-sm-10">
									<a type="button" class="btn btn-sm btn-default" id="formReturn" href="${pageContext.request.contextPath }/agent/shop/shopAdmin.jsp">返回</a>

        ...
        <section id="about">
            <div class="container">
				...
				<div class="row">
                   ...
                   <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                        	<a href="${pageContext.request.contextPath}/ProductAction_dlsGetRepository?idOwner_rep=${agent1.id_dls}">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">                            
                            <a  href="${pageContext.request.contextPath}/ShopAction_list?id_dls=${agent1.id_dls}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                        	<a href="${pageContext.request.contextPath}/ApplyAction_AgentApplyChange?userid=${agent1.id_dls}">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                        	<a href="${pageContext.request.contextPath}/OrderAction_searchAlldlsOrder?sellerid=${agent1.id_dls}">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect1">
                        <a href="${pageContext.request.contextPath}/quality.jsp">

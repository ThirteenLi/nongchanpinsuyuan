			...
			<div class="panel panel-default">
				<div class="panel-heading">输入变更申请</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm3" enctype="multipart/form-data" action="ApplyAction_AgentContectAdmin" method="POST">
							...
							<div class="form-group">
						    	...
						    	<div class="col-sm-8">
						    		  <select name="applycategory" id="applycategory"  class="selectpicker show-tick form-control" data-live-search="true">
							 			 	 <option value="代理商信息变更" selected="selected">信息变更申请</option>
											 <option value="代理商留言">留言</option>											
								      </select>
						    	</div>
							</div>

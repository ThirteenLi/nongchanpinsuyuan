        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach var="order" items="${sessionScope.orderdlspageBean.list }">
	                 	...
	                 	<tr>
	                		...
	                		href="${pageContext.request.contextPath }/OrderAction_DLSGetOneOrder?id_order=${order.id_order }">确认订单</a></td>
            ...
            <div style="float: left;">
	            <form method=post id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/ProductAction_NHGetRepository?idOwner_rep=${farmer1.id_nh}">
	 				<!-- 隐藏域.当前页码 -->
					<input type="hidden" name="currentPage" id="currentPageInput" value="${orderdlspageBean.currentPage }" />
					<!-- 隐藏域.每页显示条数 -->
						...
						<td>
							<span id=pagelink>
								<div style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">							
									第[<c:out value="${orderdlspageBean.currentPage }"></c:out>]页,
									共[<c:out value="${orderdlspageBean.totalPage }"></c:out>]页													

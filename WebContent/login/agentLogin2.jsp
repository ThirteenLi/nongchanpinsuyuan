	...
	<div class="am-g myapp-login">
		<div class="myapp-login-logo-block">
			...
			<div class="login-font">
				<a href="${pageContext.request.contextPath }/login/customerLogin2.jsp">消费者登录 </a> 或 <span> <a href="${pageContext.request.contextPath }/login/farmerLogin2.jsp">农户登录 </a></span>
				...
				<form class="am-form">
					<fieldset>
						<div class="am-form-group">
							<input type="email" class="" id="doc-ipt-email-1" placeholder="请输入手机号">
						</div>
